    ...
    >
      <nav class="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <a routerLink="/" class="flex items-center gap-3 group">
          <div class="relative w-9 h-9 rounded-xl bg-gradient-to-br from-violet-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-violet-900/40 group-hover:scale-105 transition-transform duration-300">
            <!-- Glowing background aura -->
            <div class="absolute inset-0 rounded-xl bg-violet-400 blur opacity-40 group-hover:opacity-75 transition-opacity"></div>
            <svg class="relative z-10 w-5 h-5 text-white" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M14.25 9.75L16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z"/>
            </svg>
          </div>
          <div class="flex flex-col text-left">
            <span class="text-lg font-black tracking-wider text-white leading-none uppercase font-sans">
              DOM
            </span>
          ...
          @for (link of navLinks; track link.path) {
            <li>
              ...
              >
                ...
                <!-- Hover underline -->
                <span class="absolute bottom-0 left-4 right-4 h-0.5 bg-gradient-to-r from-violet-500 to-indigo-500
        ...
        >
          ...
          <span class="w-4 h-0.5 bg-violet-400 transition-all duration-300"
