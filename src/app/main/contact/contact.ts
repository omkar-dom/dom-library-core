...
@Component({
  ...
  template: `
    <section class="relative min-h-screen bg-slate-950 py-24 flex items-center justify-center overflow-hidden antialiased">
      ...
      <div class="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2
                  ...
                  bg-gradient-to-r from-violet-600 to-indigo-600 pointer-events-none animate-pulse-slow"></div>

      <!-- Blue orb -->
      <div class="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2
                  w-[400px] h-[400px] rounded-full opacity-10 blur-[120px]
                  bg-gradient-to-r from-cyan-500 to-blue-600 pointer-events-none animate-pulse-slower"></div>

      <div class="relative w-full max-w-5xl mx-auto px-6 z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        
        <!-- Info Panel (5/12 column) -->
        <div class="lg:col-span-5 space-y-8 text-left">
          <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-500/10 text-violet-300 text-xs font-semibold uppercase tracking-wider border border-violet-500/20">
          ...
          <h1 class="text-4xl md:text-5xl font-black text-white tracking-tight leading-none">
            Let's build <br>
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-300">something grand.</span>
          </h1>
          
          <p class="text-slate-400 text-base leading-relaxed max-w-md">
            Whether you want to contribute to the DOM Library Core engine, request custom control integrations, or inquire about commercial extensions—feel free to drop a line.
          </p>

          <!-- Contact Coordinates cards -->
          <div class="space-y-4">
            <!-- Email Card -->
            <div class="group flex items-center justify-between p-4 bg-slate-900/60 border border-slate-800 rounded-2xl hover:border-violet-500/40 hover:bg-slate-900 transition-all duration-300">
              <div class="flex items-center gap-4">
                <div class="w-11 h-11 rounded-xl bg-violet-500/10 border border-violet-500/20 flex items-center justify-center group-hover:bg-violet-600 group-hover:text-white transition-colors duration-300">
                  <i class="fa-solid fa-envelope text-violet-400 group-hover:text-white"></i>
                </div>
                <div>
                  <span class="text-xs text-slate-500 uppercase tracking-widest block font-bold">Email Address</span>
                  <a href="mailto:dandavateomkar@gmail.com" class="text-sm font-semibold text-slate-200 hover:text-violet-300 transition-colors">dandavateomkar&#64;gmail.com</a>
                </div>
              </div>
              <button (click)="copyText('dandavateomkar@gmail.com', 'email')" 
            ...
            <div class="group flex items-center justify-between p-4 bg-slate-900/60 border border-slate-800 rounded-2xl hover:border-violet-500/40 hover:bg-slate-900 transition-all duration-300">
              <div class="flex items-center gap-4">
                ...
                <div>
                  <span class="text-xs text-slate-500 uppercase tracking-widest block font-bold">Phone Number</span>
                  <a href="tel:+919961992133" class="text-sm font-semibold text-slate-200 hover:text-violet-300 transition-colors">+91 9961992133</a>
                </div>
              </div>
              <button (click)="copyText('+91 9961992133', 'phone')" 
                      class="px-3 py-1.5 text-[10px] font-bold text-slate-400 hover:text-white bg-slate-950/60 border border-slate-800 rounded-lg hover:border-slate-700 transition-all">
        ...
        <div class="lg:col-span-7">
          <div class="relative bg-slate-900/40 border border-slate-800/80 rounded-3xl p-8 md:p-10 shadow-2xl backdrop-blur-xl">
